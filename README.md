...
1. Search Bar implemetation
2. add filters such as ratings, city, reviews etc.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/kd6GlSj.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Having the table view display the cells when specifing or not specifing a restuarant name.
